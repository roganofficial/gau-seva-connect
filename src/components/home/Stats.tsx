...
const Stats = () => {
  return <section className="bg-gaushala-cream mx-0 my-0 py-[64px]">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          <StatItem icon={Heart} value="5,000+" label="Cows Rescued" />
          <StatItem icon={Utensils} value="1M+" label="Meals Served" />
          <StatItem icon={Calendar} value="20+" label="Years of Service" />
          <StatItem icon={Users} value="10,000+" label="Supporters" />
        </div>
      </div>
    </section>;
};
