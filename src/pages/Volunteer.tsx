    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gaushala-cream py-12">
          <div className="container mx-auto px-4">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Volunteer With Us</h1>
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                Join our team of dedicated volunteers and make a direct impact on the lives of our cows.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-semibold text-center mb-12 text-gray-900">Volunteer Opportunities</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              <Card>
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-center text-gray-900">Cow Care Assistant</h3>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-center text-gray-900">Event Volunteer</h3>
                  <ul className="list-disc pl-5 space-y-2 text-gray-700">
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-center text-gray-900">Administration Support</h3>
                  <ul className="list-disc pl-5 space-y-2 text-gray-700">
            ...
            <div className="bg-gaushala-cream p-6 rounded-lg mb-16">
              <h3 className="text-xl font-semibold mb-4 text-center text-gray-900">Why Volunteer With Us?</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-700">Your time directly contributes to the welfare and happiness of our cows.</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  <div className="h-12 w-12 rounded-full bg-gaushala-saffron-100 flex items-center justify-center mb-4">
                  ...
                  <p className="text-gray-700">Connect with like-minded individuals who share your passion for animal welfare.</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  <div className="h-12 w-12 rounded-full bg-gaushala-saffron-100 flex items-center justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gaushala-saffron-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <p className="text-gray-700">We work with your schedule to find volunteer opportunities that fit your availability.</p>
                </div>
              </div>
            </div>
            ...
            <div id="volunteer-form" className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-semibold text-center mb-8 text-gray-900">Become a Volunteer</h2>
              ...
              <Card>
                <CardContent className="pt-6">
                  <form className="space-y-6">
                    ...
                    <Button type="submit" className="w-full bg-gaushala-green-600 hover:bg-gaushala-green-700">
                      Submit Application
                    </Button>
                  </form>
                </CardContent>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-semibold text-center mb-12 text-gray-900">Volunteer Experiences</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700 italic mb-4">
                    "Volunteering at गौ सेवा Connect has been a transformative experience. The connection I've formed with the cows and the sense of purpose I feel is incredible."
                  </p>
                  <div className="text-center">
                    <h4 className="font-semibold">Rahul Singh</h4>
                    <p className="text-gray-600 text-sm">Volunteer since 2022</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700 italic mb-4">
                    "I started volunteering during weekends, and it's become the highlight of my week. The staff is supportive, and the work we do makes a real difference in the lives of these sacred animals."
                  </p>
                  <div className="text-center">
                    <h4 className="font-semibold">Priya Verma</h4>
                    <p className="text-gray-600 text-sm">Volunteer since 2023</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-700 italic mb-4">
                    "After retirement, I was looking for meaningful ways to spend my time. Helping at the Gaushala has given me purpose and joy. I've learned so much about these gentle creatures."
                  </p>
                  <div className="text-center">
                    <h4 className="font-semibold">Mohan Patel</h4>
                    <p className="text-gray-600 text-sm">Volunteer since 2021</p>
                  </div>
                </CardContent>
              </Card>
            </div>
