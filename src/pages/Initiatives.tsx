            ...
            <Tabs defaultValue="daily-operations" id="initiatives-tabs">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <Card>
                    <CardContent className="pt-6">
                      <h2 className="text-2xl font-semibold mb-6 text-gaushala-green-600">Feeding Routines</h2>
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="md:w-1/2">
                            <p className="text-gray-700 mb-4">
                              Our cows receive carefully balanced meals three times a day, consisting of nutritious fodder, fresh greens, and specially prepared feed supplements.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                              <li><strong>Morning (6 AM):</strong> Fresh green fodder and hay</li>
                              <li><strong>Afternoon (12 PM):</strong> Mixed feed with proteins and minerals</li>
                              <li><strong>Evening (6 PM):</strong> Dry fodder and special supplements</li>
                            </ul>
                            <p className="text-gray-700 mt-4">
                              Each cow's diet is monitored by our nutritionist to ensure optimal health and wellbeing.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <Card>
                    <CardContent className="pt-6">
                      <h2 className="text-2xl font-semibold mb-6 text-gaushala-green-600">Medical Care Protocols</h2>
                      <div className="space-y-6">
                        <div className="flex flex-col md:flex-row gap-6">
                          <div className="md:w-1/2">
                            <img 
                          ...
                          <div className="md:w-1/2">
                            <p className="text-gray-700 mb-4">
                              Our comprehensive healthcare program ensures each cow receives regular check-ups and prompt treatment when needed.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                              <li><strong>Weekly Check-ups:</strong> General health assessment by our staff</li>
                              <li><strong>Monthly Visits:</strong> Thorough examination by veterinarians</li>
                              <li><strong>Bi-annual Vaccination:</strong> Protection against common bovine diseases</li>
                              <li><strong>24/7 Emergency Care:</strong> On-call veterinary support</li>
                            </ul>
                            <p className="text-gray-700 mt-4">
                              Our medical facility is equipped with modern diagnostic tools and treatments.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <Card className="lg:col-span-2">
                    <CardContent className="pt-6">
                      <h2 className="text-2xl font-semibold mb-6 text-gaushala-green-600">Shelter Management</h2>
              ...
              <TabsContent value="festivals">
                <div className="space-y-12">
                  <div>
                    <h2 className="text-2xl font-semibold mb-6 text-gray-900">Festival Celebrations at Our Gaushala</h2>
                    <p className="text-lg text-gray-700 mb-8">
                      We celebrate traditional festivals that honor cows and their sacred place in Indian culture, inviting the community to participate in these joyous occasions.
                    </p>
                  </div>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="flex items-start mb-4">
                          ...
                          <div className="ml-4">
                            <h3 className="text-xl font-semibold text-gray-900">Gopashtami</h3>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="flex items-start mb-4">
                          ...
                          <div className="ml-4">
                            <h3 className="text-xl font-semibold text-gray-900">Govardhan Puja</h3>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="flex items-start mb-4">
                          ...
                          <div className="ml-4">
                            <h3 className="text-xl font-semibold text-gray-900">Makara Sankranti</h3>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="flex items-start mb-4">
                          ...
                          <div className="ml-4">
                            <h3 className="text-xl font-semibold text-gray-900">Pongal</h3>
                  ...
                  <div className="bg-gaushala-cream p-6 rounded-lg">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900">Join Our Celebrations</h3>
                    </div>
                    <p className="text-gray-700">
                      We welcome visitors to participate in these sacred celebrations. These events not only honor our cultural traditions but also help raise awareness about cow protection. To join an upcoming festival celebration, please contact us for dates and details.
                    </p>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="gallery">
                <div>
                  <h2 className="text-2xl font-semibold mb-6 text-gray-900">Media Gallery</h2>
                  <p className="text-lg text-gray-700 mb-8">
                    Explore images of our Gaushala, the cows in our care, and the various events and activities we conduct throughout the year.
                  </p>
                  ...
                  <div className="mt-12">
                    <h3 className="text-xl font-semibold mb-4 text-gray-900">Awards & Recognition</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <Card>
                        <CardContent className="pt-6">
                          ...
                          <h4 className="text-lg font-semibold text-center mb-2">Best Animal Shelter 2023</h4>
                          <p className="text-gray-600 text-center">
                            Awarded by Rural Welfare Association for excellence in animal care and welfare practices.
                          </p>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        <CardContent className="pt-6">
                          ...
                          <h4 className="text-lg font-semibold text-center mb-2">Environmental Impact Award</h4>
                          <p className="text-gray-600 text-center">
                            Recognized for our sustainable biogas project and eco-friendly practices in Gaushala management.
                          </p>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        <CardContent className="pt-6">
                          ...
                          <h4 className="text-lg font-semibold text-center mb-2">Community Service Excellence</h4>
                          <p className="text-gray-600 text-center">
                            Honored for our contribution to rural employment and community development initiatives.
                          </p>
                        </CardContent>
                      </Card>
                    </div>
