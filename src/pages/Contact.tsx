          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                  ...
                  <form className="space-y-6">
                    ...
                    <Button type="submit" className="bg-gaushala-green-600 hover:bg-gaushala-green-700 text-white px-6 py-2">
                      Submit Message
                    </Button>
                  </form>
                </div>
              ...
              <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-gray-700 mt-1">
                            <a href="tel:+911234567890" className="hover:text-gaushala-green-600">+91 12345 67890</a> (General Inquiries)
                            <br />
                            <a href="tel:+911234567891" className="hover:text-gaushala-green-600">+91 12345 67891</a> (Cow Rescue Helpline)
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-gray-700 mt-1">
                            <a href="mailto:info@gauseva-connect.org" className="hover:text-gaushala-green-600">info@gauseva-connect.org</a>
                            <br />
                            <a href="mailto:donations@gauseva-connect.org" className="hover:text-gaushala-green-600">donations@gauseva-connect.org</a> (For donation inquiries)
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                ...
                <Card>
                  <CardContent className="pt-6">
                    <h3 className="font-semibold text-gray-900 mb-3">Connect with us on WhatsApp</h3>
