        ...
        <div className="flex items-start">
          ...
          <div className="ml-4 flex-1">
            <div className="flex justify-between items-start">
              ...
              <span className="text-gaushala-saffron-500 font-medium">
                {amount}
              </span>
            </div>
  ...
  const platinumDonors: DonorProps[] = [
    {
      ...
      date: "March 15, 2024",
      message:
        "In memory of our parents who taught us the value of cow protection.",
  ...
  const impactStories = [
    {
      ...
      description:
        "Ganga, a severely injured cow rescued from the roadside, received specialized medical treatment funded by the Agarwal family. Their donation covered surgery and six months of rehabilitation, and today Ganga is healthy and thriving in our sanctuary.",
      image:
    ...
    },
    {
      ...
      description:
        "The Sharma Foundation's generous contribution enabled us to build a modern veterinary facility equipped with diagnostic tools and treatment areas. This facility now serves all 1,000+ cows in our care, providing timely medical intervention and preventive healthcare.",
      image:
    ...
    },
    {
      ...
      description:
        "Dr. Patel's donation funded the construction of three new shelters with insulated walls and heated floors, protecting over 200 cows from harsh winter conditions. These structures have dramatically improved the comfort and health of our elderly cows.",
      image:
              ...
              <div className="flex items-center">
                ...
                <div
                  ...
                  className={`relative inline-block w-12 h-6 rounded-full cursor-pointer ${
                    showAnonymous ? "bg-lime-500" : "bg-gray-500"
                  }`}
                >
                  <input
                    type="checkbox"
              ...
              <TabsContent value="platinum">
                <div className="grid grid-cols-1 gap-6">
                  {platinumDonors.map((donor, index) => {
                    if (donor.name === "Anonymous Donor" && !showAnonymous)
                      return <></>;
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                See how your donations are making a tangible difference in the
                lives of our cows and the sustainability of our Gaushala.
              </p>
            </div>
              ...
              {impactStories.map((story) => (
                <Card key={story.id} className="overflow-hidden">
                  ...
                  <CardContent className="pt-6">
                    ...
                    <p className="text-gaushala-green-600 mb-3">
                      Supported by: {story.donor}
                    </p>
        ...
        <section className="py-12 bg-gaushala-green-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Your contribution can make a significant impact in the lives of
